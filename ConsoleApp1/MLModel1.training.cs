...
namespace ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\tomas\OneDrive - SŠINFIS\pvs3\p1\inputs.txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"col0", @"col0"),new InputOutputColumnPair(@"col1", @"col1")})      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.LbfgsMaximumEntropy(new LbfgsMaximumEntropyMulticlassTrainer.Options(){L1Regularization=6.4000726F,L2Regularization=1.0710622F,LabelColumnName=@"col2",FeatureColumnName=@"Features"}))      
